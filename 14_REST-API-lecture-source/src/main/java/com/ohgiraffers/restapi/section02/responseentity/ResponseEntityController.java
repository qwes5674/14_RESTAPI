...
public class ResponseEntityController {
    ...
    * */
    ...
    public ResponseEntity<ResponseMessage>findAllUsers(){
        ...
        return new ResponseEntity<>(/* body, headers, HttpStatuse */
            responseMessage, headers, HttpStatus.OK
        );
    }

    // pathVariable 에 식별자 사용
    ...
    public ResponseEntity<ResponseMessage> findUserByNo(@PathVariable int userNo){
        ...
        // PathVariable 로 받은 userNo와 일치하는 회원정보 하나 가져오기
    ...
    public ResponseEntity<?> regist(@RequestBody UserDTO newUser){
        ...
        System.out.println("nameUser = " + newUser);
