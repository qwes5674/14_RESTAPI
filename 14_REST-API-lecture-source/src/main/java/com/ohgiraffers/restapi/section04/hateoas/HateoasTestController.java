...
public class HateoasTestController {
    ...
    /*
    * Hateoas 란?
    * 하나의 api를 동작시켰을 때, 그전 사오항이나 그 후 상황에 대한 링크를
    ...
    * */
    ...
    public HateoasTestController(){
        ...
        users.add(new UserDTO(3,"user02","pass02","코알라", LocalDate.now()));
        users.add(new UserDTO(2,"user03","pass03","곰", LocalDate.now()));
    }

    //단건조회
    @GetMapping("/users/{usersNo}")
